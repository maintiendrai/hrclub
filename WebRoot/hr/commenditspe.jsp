  ...
  document.checkform.isshow.value='0';
   ...
   <%} %>
		<form name="checkform" method="post"
			...
			<table width="500" height="235" border="0">
				<tr>
					<td  colspan="2">
						请填写专业信息	下一步填写工作经历		</td>
  ...
  <td ><strong class="norTit">职位类型</strong><br /><select id="SltAddrA" class="SltBar" name="alljob" size="12"  multiple="true">
    <%  
    	...
    	Iterator itjob = listjob.keySet().iterator();
						while (itjob.hasNext()) {
               %>
    <option  value=<%=itjob.next().toString()%> >	<%= listjob.get(itjob.next()).toString()%></option>
   <%} %>
  </select>
  </td>
  <td >
				...
				<tr>
					<td colspan="2" >
						<div>
							...
							<input type=button name="Submit" value=" 提 交 "
								onClick="jscheckform();" class=btn1_mouseout onmouseover="this.className='btn1_mouseover'"
             onmouseout="this.className='btn1_mouseout'" />
							<input type="reset" name="Submit2" value=" 重 置 " class=btn1_mouseout onmouseover="this.className='btn1_mouseover'"
             onmouseout="this.className='btn1_mouseout'" />
						</div>
					</td>
				</tr>
