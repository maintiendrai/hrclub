...
<table border=0 cellspacing=0 cellpadding=0 width="98%" class="small">
	...
	<tr> 
		<td colspan="2"  class="dvInnerHeader"><b>专业类型列表</b></td>
...
<tr>
	...
	%>
	<a href='specialitycomflist.do?operation=specialitycomflist&pageNum=1&pageLength=<%=mypage.getPageLength() %>'>首页</a>&nbsp;&nbsp;
	<a href='specialitycomflist.do?operation=specialitycomflist&pageNum=<%=mypage.getPageNum()-1 %>&pageLength=<%=mypage.getPageLength() %>'>上页</a>&nbsp;&nbsp;
	<%
	}%>
	...
	%>
	<a href='specialitycomflist.do?operation=specialitycomflist&pageNum=<%=mypage.getPageNum()+1 %>&pageLength=<%=mypage.getPageLength() %>'>下页</a>&nbsp;&nbsp;
	<a href='specialitycomflist.do?operation=specialitycomflist&pageNum=<%=mypage.getPageCount() %>&pageLength=<%=mypage.getPageLength() %>'>末页</a>
	<%
	}}%> 
