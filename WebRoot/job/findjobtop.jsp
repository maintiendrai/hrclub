...
</head>  <% Object useid=session.getAttribute("userid");
...
<table width="558" border="0" align="center" cellpadding="0"
							...
							<tr><td colspan="2"><strong><img src="<%=url%>/images/icon-01.jpg" width="20" height="18" align="absmiddle"> 更多精确搜索条件：</strong></td>
							</tr>
							<tr>
								<td width="63">
									<div id='jobdiv'
  ...
  <td class="slt"><strong class="norTit">选择职位</strong><br />
										...
										<table width=100% align=left border=0 cellSpacing=0
											...
											<tr>
												<td colspan＝2 align=left>
													...
													<table>
														<tr>
  <td ><strong class="norTit">行业类型</strong><br /><select id="calla" class="SltBar" name="alljob" size="12"  multiple="true">
  ...
  <td >
  <input type="button" class="BtnA2w" name="" value="添加" onClick="Mv('calla','callb');" /><br />
  <br /><input type="button" class="BtnB2w" name="" value="移除" onClick="Mvout('callb','calla');" />
    <br />
  <br /><input type=button value='确定' name="industry"onclick="chosecall('callb','calldiv');">

  <br />
  <br /><input type=button value='关闭' name="industry"onclick="hidedivSimple('calldiv');">
  </td>
  
  <td><strong class="norTit">选择行业</strong><br />
  <select  id="callb" class="SltBar" name="choosejob" size="12"  style="width:200 "  multiple="true" >
									...
									<input type="text" style="width:240px;height:23px;"
										name="bycalling" value="选择行业类型" onClick="javascript:showdiv('calldiv')"
										readonly="readonly" />
								</td>
								<td></td>
							</tr>
...
<table border=0 cellspacing=0 cellpadding=0 width="480" class="small" align="center">

<tr>
    <td >发布时间</td>
    <td >
        <select name="bytime" style="width: 100" class="inputtype" >
        <option selected="selected" value="no"/>--请选择--</option>
        <option value="1"> 近一天</option>
        <option value="3"> 近三天</option>
        <option value="7"> 近一周</option>
        <option value="14"> 近二周</option>
        <option value="30"> 近一月</option>
        <option value="90"> 近三月</option>
        </select>
    <td >&nbsp;工作类型</td>
    <td>
        <select name="bykind" style="width: 100" class="inputtype">
        <option selected="selected" value="no">--请选择--</option>
    ...
    <td >&nbsp;学历要求</td>
    <td>
        <select name="bydegree" style="width: 100" class="inputtype">
        <option selected="selected" value="no"> --请选择--</option>
...
<tr>
    <td>工作年限</td>
    <td>
        <select name="byyear" style="width: 100" class="inputtype">
        <option selected="selected" value="no"> --请选择--</option>
    ...
    <td>&nbsp;公司性质</td>
    <td>
        <select name="bycorpkind"style="width: 100" class="inputtype" > 
        <option selected="selected" value="no"> --请选择--</option>
        <option value="1">国有企业</option>
        <option value="2">私营企业</option>
        <option value="3">外资独资企业</option>
    ...
    <td>&nbsp;预期薪水</td>
    <td>
<select name="bywage" style="width: 100" class="inputtype">
  ...
  <tr>
  <td height="50"  colspan="6" align="center"> <br/>
  <input type="button" name="Submit3" value="·开始搜索·" class=btn1_mouseout onMouseOver="this.className='btn1_mouseover'"
             onmouseout="this.className='btn1_mouseout'" onClick="simfindjob()" />
  </td>
</tr>
</table>
		  <tr>
        <td><img src="<%=url %>/images/main_3.gif" width="558"  alt="" /></td>
      </tr>
      	</table>
      	</td>
      	</tr>
