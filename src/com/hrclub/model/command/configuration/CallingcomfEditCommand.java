...
public class CallingcomfEditCommand extends Command{
	static org.apache.log4j.Logger logger = Logger.getLogger();

	public String getName() {
		return CommandFactory.CALLINGCOMF_EDIT;
	}
	...
	public Object execute(HttpServletRequest request,
			...
			to.setCallingID(callingID);
			to.setCallingname(callingname);

			boolean flag = ComfManager.getInstance().updateCalling(to);
