...
public class JobComfAddCommand extends Command {

	static org.apache.log4j.Logger logger = Logger.getLogger();

	public String getName() {
		return CommandFactory.JOBCOMF_ADD;
	}
	...
	public Object execute(HttpServletRequest request,
		...
		if (request.getParameter("method").equals("addItem")) {
			resultPage = ApplicationResources.JOBCOMF_ADD;
		...
		if (request.getParameter("method").equals("add")) {
			...
			boolean flag = ComfManager.getInstance().insertJob(to);
