...
public class MovementactorDelCommand extends Command {

	static org.apache.log4j.Logger logger = Logger.getLogger();

	public String getName() {
		return CommandFactory.MOVEMENTACTOR_DELETE;
	}
	...
	public Object execute(HttpServletRequest request,
		...
		boolean flag = MovementactorManager.getInstance().delete(maID);
